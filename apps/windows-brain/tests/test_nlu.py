...
def test_nlu_parse_first_line():
    ...
    # Test "첫줄"
    result1 = engine.parse("첫줄의 글자 크기를 30pt로 만들어")
    ...
    # Test "첫 줄" (with space)
    result2 = engine.parse("첫 줄의 글자 크기를 20pt로 변경해줘")
    ...
    # Test "first line"
    result3 = engine.parse("first line bold")
...
def test_nlu_parse_all():
    ...
    # Test "전체"
    result = engine.parse("문서 전체 글꼴을 맑은 고딕으로")
